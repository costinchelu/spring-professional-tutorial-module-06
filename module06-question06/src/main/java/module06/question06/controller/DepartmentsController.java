package module06.question06.controller;

import module06.question06.dao.DepartmentsDao;
...
public class DepartmentsController {
    ...
    @GetMapping("/departments/view/{departmentId}")
    public ModelAndView view(@PathVariable int departmentId) {
        return new ModelAndView("department-view", "department", departmentsDao.findById(departmentId));
    }
