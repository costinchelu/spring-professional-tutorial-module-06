package module06.question04.security;

import module06.question04.security.filter.CustomRequestParameterAuthenticationFilter;
...
import static module06.question04.security.SecurityRoles.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                ...
                .roles(DEPARTMENTS_PAG_VIEW)
                .and()
                .withUser("lucas")
                .password(encoder.encode("lucas"))
                .roles(CUSTOMERS_PAG_VIEW)
                .and()
                .withUser("tom")
