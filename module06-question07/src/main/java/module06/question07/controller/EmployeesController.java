package module06.question07.controller;

import module06.question07.dao.EmployeesDao;
...
public class EmployeesController {
    ...
    public ModelAndView view(@PathVariable int employeeId) {
        return new ModelAndView("employee-view", "employee", employeesDao.findById(employeeId));
    }
